...
\section{Contact}
%\begin{spacing}{1}
\textbf{University:}~{\bf Fudan University}, Shanghai\hfill \textbf{Job Intension}:~Software Development, Data Mining \\
...
\section{Education}
 ...
 \item Shanghai Key Lab of Intelligent Information Processing, \textbf{TA of C language programming}
 \item Advisor: Prof. Zhou Shuigeng 
 \end{itemize}
...
Machine learning, data mining. Interested in data structure and algorithm, read some parts of several classical books, such as Beauty of Programming, Programming Pearls, Introduction to Algorithm, etc.
...
\item Exploit \textbf{topic model-LDA}, k-mer represents word, sequence represents document. Firstly, extracting k-mer frequencies from sequences, then transforming reads from k-mer space to topic space, and finally clustering reads with SKWIC algorithm. Paper was accepted by a conference and submitted to \emph{BMC Bioinformatics}.
\end{itemize}
...
\end{itemize}
Gobang Game \hfill Jun.2010$\sim$Jul.2010
\begin{spacing}{0.1}
\end{spacing}
\begin{itemize}
\item Gobang game including \textbf{AI algorithm} using Visual Basic
\item \url{https://github.com/zhangruichang/Gobang}
\end{itemize}
\section{Publication}
